...
async def run_enrichment_background() -> None:
    """Enriches vehicles with Wikimedia images without blocking API responses."""
    ...
    try:
        ...
        for index, vehicle in enumerate(vehicles):
            ...
            # Yield to the event loop so other requests stay responsive.
            ...
            try:
                ...
                enrichment_progress["lastError"] = str(vehicle_exc)
            ...
            if (index + 1) % 10 == 0:
                try:
                    ...
                    pass  # non-fatal — will retry on the next batch
